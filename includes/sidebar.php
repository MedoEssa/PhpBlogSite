	...
	<section id="search" class="widget-search card widget">
		<form method="post" class="searchform durja-searchform" action="/blog/search.php">
			<div class="input-group">
				<input id="put" type="text" name="search" class="form-control s" placeholder="Search for...">
	...
	<section id="durja-about-widget2" class="widget card durja-about-widget">
		...
		<div class="durja-about-widget">
			<div class="durja-about-img">
				<a href="#">
					<img src="/blog/images/girl-1561979_1280-e1497331736191.jpg">
				</a>
			</div>
			<div class="card-block">
				<p>Ei quaeque urbanitas gloriatur eam, aliquip intellegam per in. Modus etiam putent ei pri, ad pro debet ponderum salutatus. </p>
				<!-- <span class="durja-about-autograph">
					<img src="images/autograph-3.png">
				</span> -->
			</div>
		</div>
	</section>
